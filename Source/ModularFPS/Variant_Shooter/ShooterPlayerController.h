 ...
 */
UCLASS(abstract)
class MODULARFPS_API AShooterPlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TSubclassOf<UJsonScoreWidget> ScoreWidgetClass;

	UPROPERTY(EditDefaultsOnly)
	TSubclassOf<UUserWidget> BoxDestroyedWidgetClass;
...
public:
	...
	UJsonScoreWidget* ScoreWidget;

	UBoxDestroyedWidget* BoxDestroyedWidget;
